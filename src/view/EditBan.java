...
public class EditBan extends javax.swing.JDialog {
    ...
    Ban x;
    static int vitri;
    List<Ban> dsBan = new Dao().getBan();
    
    public EditBan(java.awt.Frame parent, boolean modal, int vt) {
        super(parent, modal);
        initComponents();
    ...
    public void setDefaultData(){
        x = dsBan.get(vitri);
        txtMa.setText(x.getMaBan());
        txtTenBan.setText(x.getTenBan());
        txtsltv.setText("" + x.getSoLuongTv());
        txtTongQuy.setText("" + x.getTongQuy());
        txtMaQuy.setText(x.getMaQuy());   
    }
    ...
    private void initComponents() {
        ...
        txtMaQuy = new javax.swing.JTextField();
        ...
        jLabel1.setText("UPDATE THÔNG TIN BAN");
        ...
        jLabel6.setText("Mã quỹ:");

        txtMa.setEditable(false);

        txtsltv.setEditable(false);

        txtTongQuy.setEditable(false);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtMaQuy, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
                        .addGap(52, 52, 52))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtMaQuy, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6))
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditBan dialog = new EditBan(new javax.swing.JFrame(), true, vitri);
    ...
    private javax.swing.JTextField txtMaQuy;

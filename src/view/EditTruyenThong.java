...
public class EditTruyenThong extends javax.swing.JDialog {
    ...
    private void initComponents() {
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(87, 87, 87)
                                        .addComponent(cmbBan, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(EditTruyenThong.class.getName()).log(
    ...
    // End of variables declaration//GEN-END:variables
        public void setEditData(HoatDong hd) {
                ...
                txtchiPhi.setText(Float.toString(hd.getKinhPhi()));
